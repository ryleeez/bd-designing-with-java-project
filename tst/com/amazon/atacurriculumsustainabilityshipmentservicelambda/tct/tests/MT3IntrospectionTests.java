...
import static com.amazon.ata.test.assertions.IntrospectionAssertions.*;

@Tag("MT03")
public class MT3IntrospectionTests {
    private static final String TYPES_PACKAGE = "com.amazon.atacurriculumsustainabilityshipmentservicelambda.types";
