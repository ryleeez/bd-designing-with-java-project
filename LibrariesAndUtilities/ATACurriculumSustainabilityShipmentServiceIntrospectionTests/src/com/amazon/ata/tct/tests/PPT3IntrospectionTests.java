...
public class PPT3IntrospectionTests {
    private static final String CLASS_DIAGRAM_PATH = "resources/sustainable_packaging_CD.puml";
    private static final String SEQUENCE_DIAGRAM_PATH = "resources/sustainable_packaging_SD.puml";
